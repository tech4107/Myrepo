...
<body lang="en">
	...
	<script language="javascript" type="text/javascript">
		...
		function validate() {
			if (!/^[a-z]*$/g.test(document.validation.username1.value)) {
				alert("Name must be characters with lower case!");
				document.validation.name.focus();
				return false;
			}
			if (/^[a-z]*$/g.test(document.validation.username1.value)) {
				var num = document.getElementById("username1").value;
				if (num.length <= 4) {
							...
							<form:form action="/signup" modelAttribute="userForm"
								...
								<div class="form-group">
									<div>
										...
										<form:input type="text" path="emailid" class="input-name" id="emailId"
								...
								<div class="form-group">
									<div>
										...
										<form:input onblur="checkLength(this)" path="username" type="text"
											class="input-name" id="username1" name="username1"
											required="" />
									</div>
								</div>
								...
								<div class="form-group">
									<div>
										...
										<form:input type="password" path="password" class="input-name" id="password1"
								...
								<div class="form-group">
									<div>
										<label for="username" class="lable-name">Phoner Number
											* </label>
										<form:input type="text" path="phone" class="input-name" id="phone"
											name="phone" required="" />
									</div>
								</div>
